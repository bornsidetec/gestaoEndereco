              ...
              case Fields[lCols].DataType of
                ...
                ftDateTime:
                  begin
                    ...
                    lJSONWriter.WriteValue(FormatDatetime('yyyy-mm-dd hh:nn:ss', Self.Fields[lCols].AsDateTime));
                  end;
                ftDate:
                  //lJSONWriter.WriteValue(FormatDatetime('DD/MM/YYYY', Self.fields[lcols].AsDateTime));
                  lJSONWriter.WriteValue(FormatDatetime('YYYY-MM-DD', Self.fields[lcols].AsDateTime));
                ftTime, ftTimeStamp:
